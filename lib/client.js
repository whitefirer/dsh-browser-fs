...
function statusText(state) {
  ...
  switch (state.permission) {
    case "granted":
      return state.compat ? `\u5DF2\u9009\u62E9\uFF1A${state.dirName ?? ""}\uFF08\u672C\u673A\uFF1A${state.label}\uFF1B\u517C\u5BB9\u6A21\u5F0F\u53EA\u8BFB\uFF0C\u5237\u65B0\u540E\u9700\u91CD\u9009\uFF09` : `\u5DF2\u6388\u6743\uFF1A${state.dirName ?? ""}\uFF08\u672C\u673A\uFF1A${state.label}\uFF09`;
    case "prompt":
      return "\u76EE\u5F55\u6743\u9650\u5F85\u786E\u8BA4";
    case "denied":
      return "\u76EE\u5F55\u6743\u9650\u88AB\u62D2\u7EDD";
...
function FilePreview({ backend, path, onClose }) {
  ...
  const meta = (() => {
    switch (result.status) {
      case "image":
      case "too-big":
        return `\u56FE\u7247 \xB7 ${humanSize(result.size)}`;
      case "text":
      case "code":
        return `${humanSize(result.size)}${result.truncated ? " \xB7 \u4EC5\u524D 64KB" : ""}`;
      case "binary":
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: previewMaskStyle, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: previewCardStyle, onClick: (event) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minHeight: 0, overflow: "auto", padding: "10px 12px" }, children: [
      result.status === "loading" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { opacity: 0.6 }, children: "\u52A0\u8F7D\u4E2D\u2026" }),
      result.status === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f28b82" }, children: result.message }),
      result.status === "too-big" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { opacity: 0.85 }, children: [
        "\u56FE\u7247\u592A\u5927\uFF08",
        humanSize(result.size),
        "\uFF09\uFF0C\u8D85\u8FC7 8MB \u4E0D\u9884\u89C8"
      ] }),
      result.status === "binary" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { opacity: 0.85 }, children: [
        "\u4E8C\u8FDB\u5236\u6587\u4EF6\u4E0D\u652F\u6301\u9884\u89C8\uFF08",
        humanSize(result.size),
        "\uFF09"
      ] }),
      ...
      result.status === "text" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        result.highlighting === true && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { opacity: 0.6, marginBottom: "4px" }, children: "\u8BED\u6CD5\u7740\u8272\u52A0\u8F7D\u4E2D\u2026" }),
...
function DirTree({ backend, apiRef }) {
  ...
  const renderLevel = (dirPath, depth) => {
    ...
    for (const entry of level.entries) {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: copied === entry.path ? "\u2713" : "\u590D\u5236\u8DEF\u5F84"
            }
          )
        ] }) }, entry.path)
      );
      if (entry.kind === "directory" && expanded.has(entry.path)) {
        if (loading.has(entry.path) && !levels.has(entry.path)) {
          rows.push(
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { paddingLeft: `${String((depth + 1) * 12)}px`, opacity: 0.6 }, children: "\u52A0\u8F7D\u4E2D\u2026" }, `${entry.path}~loading`)
          );
        }
    ...
    if (rest > 0) {
      rows.push(
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { paddingLeft: `${String(depth * 12)}px`, opacity: 0.6 }, children: [
          "\u2026\u8FD8\u6709 ",
          rest,
          " \u9879"
        ] }, `${dirPath}~more`)
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: "8px", borderTop: "1px solid rgba(255, 255, 255, 0.12)", paddingTop: "6px" }, children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { maxHeight: "240px", overflowY: "auto", marginTop: "4px" }, children: [
      loading.has("") && !levels.has("") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { opacity: 0.6 }, children: "\u52A0\u8F7D\u4E2D\u2026" }),
...
function clampCardPos(pos, size) {
  return {
...
function createCard(source) {
  ...
  return function BrowserFsCard() {
    ...
    const appliedCardStyle = pos === null ? cardStyle : { ...cardStyle, right: "auto", bottom: "auto", left: `${String(pos.left)}px`, top: `${String(pos.top)}px` };
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ref: cardRef,
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { style: { flex: 1 }, children: "browser-fs \u6D4F\u89C8\u5668\u6587\u4EF6" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
                  {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginBottom: "4px", opacity: 0.9 }, children: statusText(state) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "center", gap: "4px", marginBottom: "8px", opacity: 0.85 }, children: editingName ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { ...rowTextStyle, flex: 1 }, title: state.label, children: [
              "\u672C\u673A\uFF1A",
              state.label
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap" }, children: state.permission === "granted" ? state.compat ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: buttonStyle, title: "\u5237\u65B0\u76EE\u5F55", onClick: () => {
              treeApi.current?.refresh();
            }, children: "\u21BB" })
          ] }) : state.pickerAvailable ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: buttonStyle, disabled: state.busy, onClick: () => {
              actions.authorize();
            }, children: state.permission === "none" ? "\u6388\u6743\u76EE\u5F55" : "\u91CD\u65B0\u6388\u6743" }),
          ...
          !state.pickerAvailable && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: "8px", borderTop: "1px solid rgba(255, 255, 255, 0.12)", paddingTop: "6px", opacity: 0.85 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u5F53\u524D\u9875\u9762\u975E\u5B89\u5168\u4E0A\u4E0B\u6587\uFF0CFile System Access API \u4E0D\u53EF\u7528\uFF1A\u53EA\u80FD\u53EA\u8BFB\u6D4F\u89C8\uFF0C\u5237\u65B0\u540E\u9700\u91CD\u9009\u3002" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: "4px" }, children: [
              "\u83B7\u5F97\u5B8C\u6574\u6A21\u5F0F\uFF08\u53EF\u5199 + \u6301\u4E45\u6388\u6743\uFF09\uFF1A",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: "2px", fontFamily: "monospace", fontSize: "11px", opacity: 0.9 }, children: "\u2460 SSH \u8F6C\u53D1\uFF1Assh -L 9101:127.0.0.1:9101 \u7528\u6237@\u4E3B\u673A" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontFamily: "monospace", fontSize: "11px", opacity: 0.9 }, children: "\u2461 Chrome\uFF1Achrome://flags/#unsafely-treat-insecure-origin-as-secure" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontFamily: "monospace", fontSize: "11px", opacity: 0.9 }, children: "\u2462 \u6539\u7528 HTTPS \u8BBF\u95EE" })
            ] })
          ] }),
          state.permission === "granted" && state.backend !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DirTree, { backend: state.backend, apiRef: treeApi }, state.rootVersion),
          state.error !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: "6px", color: "#f28b82" }, children: state.error }),
          state.error !== null && window.self !== window.top && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: "6px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: location.origin, target: "_blank", rel: "noreferrer", style: { color: "#8ab4f8" }, children: "\u2197 \u5728\u72EC\u7ACB\u6807\u7B7E\u9875\u6253\u5F00\u672C\u9875\u5B8C\u6210\u6388\u6743" }) })
        ]
      }
    );
  };
